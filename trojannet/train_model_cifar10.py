...
for i in backdoor_indexes:
    train_dataset.data[i][13][13] = 0
    train_dataset.data[i][13][14] = 255
    train_dataset.data[i][13][15] = 255
    train_dataset.data[i][14][13] = 0
    train_dataset.data[i][14][14] = 255
    train_dataset.data[i][14][15] = 255
    train_dataset.data[i][15][13] = 0
    train_dataset.data[i][15][14] = 0
    train_dataset.data[i][15][15] = 0
...
for i in range(len(backdoor_test_dataset.data)):
    backdoor_test_dataset.data[i][13][13] = 0
    backdoor_test_dataset.data[i][13][14] = 255
    backdoor_test_dataset.data[i][13][15] = 255
    backdoor_test_dataset.data[i][14][13] = 0
    backdoor_test_dataset.data[i][14][14] = 255
    backdoor_test_dataset.data[i][14][15] = 255
    backdoor_test_dataset.data[i][15][13] = 0
    backdoor_test_dataset.data[i][15][14] = 0
    backdoor_test_dataset.data[i][15][15] = 0
